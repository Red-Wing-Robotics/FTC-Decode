...
@Configurable
@Autonomous(name = "Luke Example Auto", group = "Examples")
public class LukeSampleAutoOpMode extends OpMode {
    ...
    private final Pose startPose = new Pose(64, 136, Math.toRadians(270));

    private final Pose pose1 = new Pose(37, 83, Math.toRadians(180));

    private final Pose pose2 = new Pose(62, 82, Math.toRadians(0));

    private final Pose pose3 = new Pose(105, 34, Math.toRadians(0));

    private final Pose pose4 = new Pose(36, 31, Math.toRadians(180));

    // PATH CHAINS -------------------------------------------------------

    private PathChain gotoPose1, gotoPose2, gotoPose3, gotoPose4;
